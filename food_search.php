...
<body>
    ...
    <?php $search=strtolower($_POST["search"]); ?>

    <section class="food_search t_center">
            <div class="container">
                
                <h1 class="search_textt">Food on your search <a href="#"><?php echo $search ?></a></h1>
    ...
    <section class="food_menu">
        <div class="container">
            ...
            <?php 
                ...
                $sql2="SELECT * FROM food WHERE LOWER(title) LIKE '%$search%' OR description LIKE '%$search%'";
