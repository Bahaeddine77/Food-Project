...
<head>
    ...
    <body>
        ...
        <section class="footer">
            <div class="container t_center">
                <p>all right deserved by <a href="#">Baha</a></p>
            </div>
